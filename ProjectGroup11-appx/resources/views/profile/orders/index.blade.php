...
@section('content')
        ...
        <div class="mt-[4.375rem] w-[80%] grid grid-cols-4 gap-6">
            <div>
                ...
                <div class="bg-white shadow-md rounded-xl">
                    <a href="{{ route('profile.orders') }}" class="w-full px-10 py-6 flex flex-row ">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"
    ...
    <div class="w-full bg-gray-50 p-6">
        ...
        <div class="bg-white text-black font-medium p-4 flex justify-between items-center border-b">
            <a href="{{ route('profile.orders.index') }}" class="text-lg font-bold cursor-pointer hover:text-[#ff8833]">ทั้งหมด</a>
            <a href="{{ route('profile.orders.pending') }}" class="text-lg font-bold cursor-pointer hover:text-[#ff8833]">ค้างชำระ</a>
            <a href="{{ route('profile.orders.completed') }}" class="text-lg font-bold cursor-pointer hover:text-[#ff8833]">สำเร็จการสั่งซื้อ</a>
            <a href="{{ route('profile.orders.cancelled') }}" class="text-lg font-bold cursor-pointer hover:text-[#ff8833]">สินค้าที่ยกเลิก</a>
        </div>
