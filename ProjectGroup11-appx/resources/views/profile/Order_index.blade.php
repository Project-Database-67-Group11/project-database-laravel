        ...
        <div class="bg-white shadow-md col-span-3 rounded-xl p-10 space-y-10">
            ...
            @if($orders->isEmpty())
                <div class="text-center ">
                    <p class="text-lg text-gray-600">ยังไม่มีคำสั่งสินค้า</p>
                </div>
            @else
                        ...
                        @foreach($orders as $order)
                            @if($order->product)
                                <a href="{{ route('profile.orders.seemore', ['allOrderId' => $order->all_order_id]) }}">
                                    <div class="bg-white shadow-md rounded-lg mb-4 p-6 hover:bg-gray-200 hover:scale-105 transition duration-200" >
