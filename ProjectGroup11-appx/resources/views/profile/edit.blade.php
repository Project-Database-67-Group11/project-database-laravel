                        ...
                        <div class="col-span-2">
                            ...
                            <div class="mt-1 flex space-x-4">
                                <label><input type="radio" name="gender" value="male"
                                        {{ Auth::user()->gender == 'male' ? 'checked' : '' }}> ชาย</label>
                                <label><input type="radio" name="gender" value="female"
                                        {{ Auth::user()->gender == 'female' ? 'checked' : '' }}> หญิง</label>
                                <label><input type="radio" name="gender" value="other"
                                        {{ Auth::user()->gender == 'other' ? 'checked' : '' }}> อื่นๆ</label>
                            </div>
                        </div>
                        <div class="col-span-2">
                            <label for="dob" class="block text-sm font-medium text-gray-700">วัน/เดือน/ปี เกิด</label>
