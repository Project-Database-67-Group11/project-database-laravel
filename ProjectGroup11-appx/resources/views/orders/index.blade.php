                ...
                <div class="h-25 flex items-center justify-between text-gray-700">
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <div class="flex flex-col gap-4 justify-center">
                            <h1 class="text-lg font-semibold text-black">ข้าวแกงกะหรี่พึ่งสั่งมา</h1>
                            <p class="text-gray-600">ข้าวแกงกะหรี่หมูทอดทงคัตสึ / ชำระเรียบร้อย</p>
                            <span class="bg-green-100 text-green-700 text-sm py-1 px-3 rounded-full w-max">ระหว่างจัดส่ง/ค้างชำระ</span>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-4 items-center justify-center">
                        ...
                        <!-- ปุ่มการกระทำ -->
                        <div class="flex gap-3">
                            <button class="bg-green-500 text-black py-2 px-4 rounded-lg hover:bg-green-600 transition hover:text-white">คืนสินค้า</button>
                            <button class="bg-blue-500 text-black py-2 px-4 rounded-lg hover:bg-blue-600 transition hover:text-white">ยกเลิก</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-md rounded-lg mb-4 p-6">
                <div class="h-25 flex items-center justify-between text-gray-700">
                    ...
                    <div class="flex flex-col gap-4 items-center justify-center">
                        ...
                        <!-- ปุ่มการกระทำ -->
                        <div class="flex gap-3">
                            <button class="bg-green-500 text-black py-2 px-4 rounded-lg hover:bg-green-600 transition hover:text-white">สั่งซื้อใหม่</button>
                            <button class="bg-blue-500 text-black py-2 px-4 rounded-lg hover:bg-blue-600 transition hover:text-white">ยกเลิก</button>
                        </div>
                    </div>
                </div>
